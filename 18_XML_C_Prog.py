import xml.etree.ElementTree as ET   # Primarily DOM, but can support SAX to some extent using iterparse()
...
def add_new_book(file_path, new_book_data):
    ...
    # Create the book element in the XML structure
...
if __name__ == "__main__":
    ...
    xml_file_path = '18_XML_B_data.xml'
