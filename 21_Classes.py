...
class Car:
    ...
    def __str__(self):
        return f"{self._make}, {self._model}, {self._color}, {self._year}, {self._registration}"
    
    def __repr__(self) -> str:
        return f"{self._make}, {self._model}, {self._color}, {self._year}, {self._registration}, WheelCount - {len(self._wheels)}, {self.serialNo}"
    
    def __eq__(self, other) -> bool:
        return self._registration.regNumber == other._registration.regNumber
    
    def GetRegNumber(self):
        return self._registration.regNumber
...
def Test1():
    ...
    c2 = Car("Toyota", "Camry", "White", 2024)
